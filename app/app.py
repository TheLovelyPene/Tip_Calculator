...
def process_payment(event_id):
    try:
        ...
        if payment_method == 'paypal' and organizer_payments.get('paypal'):
            # Generate PayPal payment link
            paypal_email = organizer_payments['paypal']
            paypal_link = f"https://www.paypal.com/paypalme/{paypal_email}/{amount}"
        ...
        elif payment_method == 'cashapp' and organizer_payments.get('cashapp'):
